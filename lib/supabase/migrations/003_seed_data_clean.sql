-- Hassan Kazmi's Terminal Portfolio - Clean Seed Data
-- This version deletes existing data first, then inserts fresh data
...
SELECT '=== SECTIONS SUMMARY ===' as info;
SELECT type, COUNT(*) as count FROM sections GROUP BY type ORDER BY type;

SELECT '=== SETTINGS SUMMARY ===' as info;
